          ...
          >
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-sm">¡Recuerda la Promoción!</div>
                  <div className="text-white/80 text-xs mt-1">Envía 4 cajas y la 5ta Small es GRATIS. Mencionalo en tu mensaje.</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
